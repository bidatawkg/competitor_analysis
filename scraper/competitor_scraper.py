...
class CompetitorScraper:
    ...
    def __init__(self, use_proxy: bool = True, headless: bool = True):
        ...
        self.manual_urls = {
            "SA": {
                "Rabona": ["https://rabona-9346.com/en/", "https://arabcasinostars.com/en/review/casino-rabona/"],
